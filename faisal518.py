...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mFAISAL-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mFAISAL-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mKFAISAL-2F.txt' %
              (H, P, str(len(twf))))
...
def cek_apk(session,coki):
    ...
    #____________#
def xyz():
    #os.system("play-audio WELCOME_TO_FAISAL_BOOT_818.mp3")
    os.getuid
